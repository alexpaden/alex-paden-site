...
export default function HomePage() {
  ...
  return (
    <main className={`flex flex-col xl:flex-row w-full min-h-screen ${theme === 'dark' ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'} overflow-visible transition-colors duration-300`}>
